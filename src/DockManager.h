...
public:
	...
	enum eConfigFlag
	{
        ...
        PerspectivesWithOutCentralWidget = 0x0200, //!< If the flag is set, ignore the central window when saving state
     ...
     * \code
	 *
	 * Use CDockManager::setStyleSheetTheme() to select the built-in theme.
     */
	void loadStyleSheet();
